    ...
    <DIV style="position: absolute; left:30px;">
        <FORM id="last_state_form" name="last_state_form" action="last_state_insert.php" method="GET" onsubmit="return check_data();">
            ...
            <div id="death_extra" style="display: none">
                <table>
                	<tr>
                		<td colspan="2">Είναι  γνωστή η ημερομηνία θανάτου του ασθενή:
                    ...
                    <tr id="deathdateunknown" style="display: none">
                        <td>
                            Ημερομηνία που έγινε γνωστό<BR>ότι ο ασθενής απεβίωσε &nbsp;
                        </td>
                        <td>
                            Ημέρα:
...
<span id="immediate_other" style="display: none">'Αλλη αιτία:<input id=othercause1 name=othercause1 onclick="window.open('./icd-10/showpage.php?page=death_other.htm&field=othercause1', 'Λόγοι', 'width=550,height=600,status=yes,scrollbars=yes,toolbar=yes');" onfocus="this.blur();">
...
<span id="contributing1_other" style="display: none">'Αλλη αιτία:<input id=othercause2 name=othercause2 onclick="window.open('./icd-10/showpage.php?page=death_other.htm&field=othercause2', 'Λόγοι', 'width=550,height=600,status=yes,scrollbars=yes,toolbar=yes');" onfocus="this.blur();">
...
<span id="contributing2_other" style="display: none">'Αλλη αιτία:<input id=othercause3 name=othercause3 onclick="window.open('./icd-10/showpage.php?page=death_other.htm&field=othercause3', 'Λόγοι', 'width=550,height=600,status=yes,scrollbars=yes,toolbar=yes');" onfocus="this.blur();">
...
<span id="contributing3_other" style="display: none">'Αλλη αιτία:<input id=othercause4 name=othercause4 onclick="window.open('./icd-10/showpage.php?page=death_other.htm&field=othercause4', 'Λόγοι', 'width=550,height=600,status=yes,scrollbars=yes,toolbar=yes');" onfocus="this.blur();">
...
<span id="contributing4_other" style="display: none">'Αλλη αιτία:<input id=othercause5 name=othercause5 onclick="window.open('./icd-10/showpage.php?page=death_other.htm&field=othercause5', 'Λόγοι', 'width=550,height=600,status=yes,scrollbars=yes,toolbar=yes');" onfocus="this.blur();">
                <?
...
<span id="underlying_other" style="display: none">'Αλλη αιτία:<input id=othercause6 name=othercause6 onclick="window.open('./icd-10/showpage.php?page=death_other.htm&field=othercause6', 'Λόγοι', 'width=550,height=600,status=yes,scrollbars=yes,toolbar=yes');" onfocus="this.blur();">
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <tr id=last_date>
                    <td>
                        Τελευταία γνωστή ημερομηνία&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <BR>
                        που ο ασθενής είναι εν ζωή: &nbsp;&nbsp;&nbsp;
                    </td>
                    <td>
                        Ημέρα:
                ...
                <tr id=withdraw_date style="display: none">
                    <td>
                        Ημερομηνία απόσυρσης συναίνεσης: &nbsp;&nbsp;&nbsp;
                    </td>
                    <td>
                        Ημέρα:
            ...
            function check_data(){
                ...
                if (doc("LastState").value == 2) {
					if (doc("deathdatetype").value == "") {
                        alert("Πρέπει να επιλέξετε αν είναι γνωστή η ημερομηνία θανάτου του ασθενή!");
                        return false;						
					}
					...
					if (doc("deathdatetype").value == "0") {
						if (doc("DateDeathKnown_year").value == "") {
							alert("Πρέπει να επιλέξετε το χρόνο στην ημερομηνία που έγινε γνωστό ότι ο ασθενής απεβίωσε!");
							return false;
						}
						if (doc("DateDeathKnown_month").value == "") {
							alert("Πρέπει να επιλέξετε το μήνα στην ημερομηνία που έγινε γνωστό ότι ο ασθενής απεβίωσε!");
							return false;
						}
						if (doc("DateDeathKnown_day").value == "") {
							alert("Πρέπει να επιλέξετε την ημέρα στην ημερομηνία που έγινε γνωστό ότι ο ασθενής απεβίωσε!");
							return false;
						}	
					}		
...
for ($i=10; $i<101; $i++)
{
	...
	{
		echo "str_ICD10_extra['".$i."'] = \"".$deaths_extra_icd10[$i]."\";\n"; // + othercause + \"', 'Λόγοι', 'width=550,height=600,status=yes,scrollbars=yes,toolbar=yes');\";\n";
	}
}
?>
...
function show_extra_icd10(code, span_id2, othercause)
{
	...
	if (str_ICD10_extra[code] != null)
	{
		...
		document.getElementById(othercause).onclick = function(){
			window.open("./icd-10/showpage.php?page=" + str_ICD10_extra[code] + "&field=" + othercause, "Λόγοι", "width=550,height=600,status=yes,scrollbars=yes,toolbar=yes")
		};
	}
	else
	{
...
<!--                                    <option value="01">01 AIDS (ongoing active disease)</option>
                                    ...
                                    <option value="901">Μεθαιμορραγικό Σοκ</option>

...
if (!$db_selected) {
   die ('Can\'t use ' . $cohort_db_name . ' : ' . mysql_error());
	...
	$posotikes_methods_query = "SELECT * FROM hcv_iologikes_methods WHERE Type=2";
	$poiotikes_methods_query = "SELECT * FROM hcv_iologikes_methods WHERE Type=1";
...
<HTML><HEAD>
<TITLE>Καταχώρηση Ιολογικής Παρακολούθησης στο Κέντρο ασθενούς με HCV συνλοίμωξη</TITLE>
...
<FORM id="iologikes_form" name="iologikes_form" action="hcv_iologikes_insert.php" method="GET" onsubmit="return check_data(1);">
<? show_patient_data($_GET['code']); ?>
<P>Iολογική εικόνα HCV-RNA
</P>
...
<FORM id="iologikes_form" name="iologikes_form" action="hcv_iologikes_insert.php" method="GET" onsubmit="return check_data(2);">   
...
<?php
$sql = "SELECT hcv_iologikes.ExamDate, hcv_iologikes.Result, hcv_iologikes.Operator, hcv_iologikes.Value, hcv_iologikes.Units, hcv_iologikes_methods.Method, hcv_iologikes.Method AS method_id FROM hcv_iologikes, hcv_iologikes_methods WHERE hcv_iologikes_methods.ID=hcv_iologikes.Method AND PatientCode=".$_GET['code'];

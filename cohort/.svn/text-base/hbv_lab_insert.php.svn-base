...
check_hbv_coinfection($_GET['PatientCode']);
$sql = "INSERT INTO `hbv_lab` VALUES ('".$_GET['PatientCode']."', '".join_date($_GET, 'ExamDate')."', '".$_GET['ALT']."', '".$_GET['AST']."', '".$_GET['gammaGT']."')";
...
echo "<p><a href='hbv_lab.php?code=".$_GET['PatientCode']."'>Καντε click εδώ για να καταχωρήσετε κι άλλη εξέταση</a></p>";

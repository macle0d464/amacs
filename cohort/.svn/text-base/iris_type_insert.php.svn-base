...
<HTML><HEAD>
<TITLE>Προσθήκη είδους IRIS</TITLE>
...
//require_once 'Text/Highlighter.php';
	...
	{
		$sql_query = "INSERT INTO iris_type VALUES('', '".$_POST['query']."')";
		$results = execute_query($sql_query);
	}
	$table_query = "SELECT * FROM iris_type";
...
<FORM METHOD=POST action="iris_type_insert.php">

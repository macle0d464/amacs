...
<HTML><HEAD>
<TITLE>Εργαστηριακή Εικόνα Ασθενούς</TITLE>
...
$sql = "SELECT * FROM ".$_GET['type']."_lab WHERE PatientCode=".$_GET['code'];
$result = execute_query($sql);
    echo "<form method=get action='delete_lab.php'>";
    echo "<input type=hidden name=count value=".mysql_num_rows($result).">";
    echo "<input type=hidden name=table value=".$_GET['type']."_lab>";

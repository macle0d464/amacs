...
<HTML><HEAD>
<TITLE>Καταχώρηση Εργαστηριακής Εικόνας ασθενούς με HCV συνλοίμωξη</TITLE>
...
<a href="show_lab.php?type=hcv&code=<?echo $_GET['code'];?>" target="_new">Προβολή Καταχωρήσεων Ασθενή</a>

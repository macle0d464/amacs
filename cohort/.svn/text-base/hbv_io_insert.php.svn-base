...
<HTML><HEAD>
<TITLE>Προσθήκη μεθόδων για HBV</TITLE>
...
//require_once 'Text/Highlighter.php';
	...
	{
		$sql_query = "INSERT INTO hbv_iologikes_methods VALUES('', '".$_POST['query']."')";
		$results = execute_query($sql_query);
	}
	$table_query = "SELECT * FROM hbv_iologikes_methods";
...
<FORM METHOD=POST action="hbv_io_insert.php">

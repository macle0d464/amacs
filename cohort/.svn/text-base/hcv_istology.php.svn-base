...
{
	Print_PatientCode_form("hcv_istology.php");
	die();
}
else
{
...
<FORM id="hcv_istology_form" name="hcv_istology_form" action="hcv_istology_insert.php" method="GET" onsubmit="return check_data()">
<input type="hidden" name=table value=hcv_istology>
...
<?php
$sql = "SELECT hcv_istology.ExamDate, hcv_istology.Activity, l1.System AS System1, hcv_istology.Score1, l2.System AS System2, hcv_istology.Score2, hcv_istology.Kirrosi, hcv_istology.Steatosi, hcv_istology.System1 AS system_id1, hcv_istology.System2 AS system_id2 FROM hcv_istology, hcv_istology_list l1, hcv_istology_list l2 WHERE hcv_istology.System1=l1.AA AND hcv_istology.System2=l2.AA AND PatientCode=".$_GET['code'];
$result = execute_query($sql);
echo mysql_error();
    echo "<form method=get action='delete_istology.php'>";
    echo "<input type=hidden name=count value=".mysql_num_rows($result).">";
    echo "<input type=hidden name=examtable value=hcv_istology>";

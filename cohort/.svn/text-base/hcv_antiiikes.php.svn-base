...
if (!$db_selected) {
   die ('Can\'t use ' . $cohort_db_name . ' : ' . mysql_error());
	...
	$medicine_query = "SELECT * FROM hcv_medicines";
...
<a href="hcv_show_antiiikes_data.php?code=<? echo $_GET['code']; ?>">
	...
	<TABLE>
		...
		<TR>
			<TD align=center style="border: 1px solid; background-color: white">
				<TABLE>
				<TR>
				<TH>Βιοχημική Ανταπόκριση</TH>
				</TR>
				<TR>
				<TD>
				<table>
				<tr><td>
				Πολύ πρώιμη<BR><i>(4 εβδομάδες)</i></td><td>
				&nbsp;&nbsp;<select name="Bioximiki_polu_prwimi">
				...
				<tr><td>
				Πρώιμη<BR><i>(12 εβδομάδες)</i></td><td>
				&nbsp;&nbsp;<select name="Bioximiki_prwimi">
				<option value=-1> - </option>
				<option value=0>OXI</option>
				<option value=1>NAI</option>
				<option value=2>ΑΓΝΩΣΤΗ</option>
				...
				<tr><td>
				24 εβδoμάδες<BR><i>(12μηνη θεραπεία)</i></td><td>
				&nbsp;&nbsp;<select name="Bioximiki_24">
				<option value=-1> - </option>
				<option value=0>OXI</option>
				<option value=1>NAI</option>
				<option value=2>ΑΓΝΩΣΤΗ</option>
				...
				<tr><td>
				Στο τέλος θεραπείας</td><td>
				&nbsp;&nbsp;<select name="Bioximiki_end">
				<option value=-1> - </option>
				<option value=0>OXI</option>
				<option value=1>NAI</option>
				<option value=2>ΑΓΝΩΣΤΗ</option>
				...
				<tr><td>
				<b>Μακροχρόνια</b><i><BR>(6 μήνες μετά<BR>την διακοπή)</i></td><td>
				&nbsp;&nbsp;<select name="Bioximiki_longterm">
				<option value=-1> - </option>
				<option value=0>OXI</option>
				<option value=1>NAI</option>
				<option value=2>ΑΓΝΩΣΤΗ</option>
			...
			<TD align=center style="border: 1px solid; background-color: white">
				...
				<tr><td>
				Πολύ πρώιμη<BR><i>(4 εβδομάδες)</i></td><td>
				&nbsp;&nbsp;<select name="Iologiki_polu_prwimi">
				<option value=-1> - </option>
				<option value=0>OXI</option>
				<option value=1>NAI</option>
				<option value=2>ΑΓΝΩΣΤΗ</option>
				...
				<tr><td>
				<b>Μακροχρόνια</b><BR><i>(6 μήνες μετά<BR>την διακοπή)</i></td><td>
				&nbsp;&nbsp;<select name="Iologiki_longterm">
				<option value=-1> - </option>
				<option value=0>OXI</option>
				<option value=1>NAI</option>
				<option value=2>ΑΓΝΩΣΤΗ</option>
...
function check_data()
{
	...
	if (document.all.EndDate_year.value != "")
	{
		...
		if (Today > EndDate)
		{
			...
			if (document.all.Iologiki_longterm.value == "-1")
			{

...
if (!$db_selected) {
   die ('Can\'t use ' . $cohort_db_name . ' : ' . mysql_error());
	...
	$posotikes_methods_query = "SELECT * FROM hcv_posotikes_iologikes_methods";
	$poiotikes_methods_query = "SELECT * FROM hcv_poiotikes_iologikes_methods";
...
<FORM id="iologikes_form" name="iologikes_form" action="iologikes_insert.php" method="GET" onsubmit="return check_data(2);">   
...
<?php
$sql = "SELECT exams_iologikes.ExamDate, exams_iologikes.Result, exams_iologikes.Operator, exams_iologikes.Value, exams_iologikes.Units, hcv_iologikes_methods.Method, exams_iologikes.Method AS method_id FROM exams_iologikes, hcv_iologikes_methods WHERE hcv_iologikes_methods.ID=exams_iologikes.Method AND PatientCode=".$_GET['code'];

...
<HTML><HEAD>
<TITLE>Προσθήκη μεθόδων για HCV</TITLE>
...
//require_once 'Text/Highlighter.php';
	...
	{
		$sql_query = "INSERT INTO hcv_iologikes_methods VALUES('', '".$_POST['query']."')";
		$results = execute_query($sql_query);
	}
	$table_query = "SELECT * FROM hcv_iologikes_methods";
...
<FORM METHOD=POST action="hcv_io_insert.php">

...
<HTML><HEAD>
<TITLE>Προσθήκη αιτιών διακοπής προφυλακτικών θεραπείων</TITLE>
...
//require_once 'Text/Highlighter.php';
	...
	{
		$sql_query = "INSERT INTO prophylactic_reasons VALUES('', '".$_POST['query']."')";
		$results = execute_query($sql_query);
	}
	$table_query = "SELECT * FROM prophylactic_reasons";
...
<FORM METHOD=POST action="prophylactic_reasons_insert.php">

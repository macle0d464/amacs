...
{
?>    
    <option value="1">Χρόνια HBV λοίμωξη</option>
<?
} 
...
{
?>
    <option value="8">Μη αντιρροπούμενη κίρρωση - Ασκίτης</option>
<?
}
if (($entry == -1) || ($entry['Kirsoi'] == NULL))
{
?>
    <option value="9">Μη αντιρροπούμενη κίρρωση - Αιμορραγία από κιρσούς</option>
<?
}
if (($entry == -1) || ($entry['Egkefalopatheia'] == NULL))
{
?>
    <option value="10">Μη αντιρροπούμενη κίρρωση - Εγκεφαλοπάθεια ηπατική</option>
<?
}
if (($entry == -1) || ($entry['Nefriki'] == NULL))
{
?>
    <option value="11">Μη αντιρροπούμενη κίρρωση - Ηπατονεφρικό Σύνδρομο</option>
<?
}
if (($entry == -1) || ($entry['Peritonitis'] == NULL))
{
?>
    <option value="12">Μη αντιρροπούμενη κίρρωση - Περιτονίτις</option>
<?
}      
*/
...
{
?> 
<!--	<option value="6">Φυσική Ανοσία</option>
	<option value="7">Προηγηθείς Εμβολιασμός</option>
	-->
	</select>
	</TD>
    </TR>
...
?>
<tr>
<td align=center><input type="checkbox" name="xronia"></td><td>&nbsp;&nbsp; Χρόνια HBV Λοίμωξη &nbsp;&nbsp;</td><td align=center></td>
</tr>
<?
} 
...
?>
<tr>
<td align=center><input type="checkbox" name="askitis"></td><td>&nbsp;&nbsp; Μη αντιρροπούμενη κίρρωση - Ασκίτης &nbsp;&nbsp;</td><td align=center><? echo $entry['Askitis'] ?></td>
</tr>
<?
}
...
?>
<tr>
<td align=center><input type="checkbox" name="kirsoi"></td><td>&nbsp;&nbsp; Μη αντιρροπούμενη κίρρωση - Αιμορραγία από κιρσούς &nbsp;&nbsp;</td><td align=center><? echo $entry['Kirsoi'] ?></td>
</tr>
<?
}    
...
?>
<tr>
<td align=center><input type="checkbox" name="egkefalopatheia"></td><td>&nbsp;&nbsp; Μη αντιρροπούμενη κίρρωση - Εγκεφαλοπάθεια ηπατική &nbsp;&nbsp;</td><td align=center><? echo $entry['Egkefalopatheia'] ?></td>
</tr>
<?
}  
...
?>
<tr>
<td align=center><input type="checkbox" name="nefriki"></td><td>&nbsp;&nbsp; Μη αντιρροπούμενη κίρρωση - Ηπατονεφρικό Σύνδρομο &nbsp;&nbsp;</td><td align=center><? echo $entry['Nefriki'] ?></td>
</tr>
<?
}  
...
?>
<tr>
<td align=center><input type="checkbox" name="peritonitis"></td><td>&nbsp;&nbsp; Μη αντιρροπούμενη κίρρωση - Περιτονίτις &nbsp;&nbsp;</td><td align=center><? echo $entry['Peritonitis'] ?></td>
</tr>
<?
}  
...
?>
<tr>
<td align=center><input type="checkbox" name="anosia"></td><td>&nbsp;&nbsp; Φυσική Ανοσία &nbsp;&nbsp;</td><td align=center></td>
</tr>
<?
} 
...
?>
<tr>
<td align=center><input type="checkbox" name="emboliasmos"></td><td>&nbsp;&nbsp; Προηγηθείς Εμβολιασμός &nbsp;&nbsp;</td><td align=center></td>
</tr>
<?
} ?>
</table>

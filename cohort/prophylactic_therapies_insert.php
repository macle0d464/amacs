...
<HTML><HEAD>
<TITLE>Προσθήκη προφυλακτικών θεραπείων HIV</TITLE>
...
//require_once 'Text/Highlighter.php';
	...
	{
		$sql_query = "INSERT INTO prophylactic_therapies_list VALUES('', '".$_POST['query']."')";
		$results = execute_query($sql_query);
	}
	$table_query = "SELECT * FROM prophylactic_therapies_list";
...
<FORM METHOD=POST action="prophylactic_therapies_insert.php">

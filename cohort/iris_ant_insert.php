...
<HTML><HEAD>
<TITLE>Προσθήκη τρόπων αντιμετώπισης IRIS</TITLE>
...
//require_once 'Text/Highlighter.php';
	...
	{
		$sql_query = "INSERT INTO iris_antimetopisi VALUES('', '".$_POST['query']."')";
		$results = execute_query($sql_query);
	}
	$table_query = "SELECT * FROM iris_antimetopisi";
...
<FORM METHOD=POST action="iris_ant_insert.php">

...
<HTML><HEAD>
<TITLE> Γενική Ούρων Ασθενούς</TITLE>
...
{ 
    ...
    <option value="-1">'Αγνωστο</option>
    <option value="1">Καθόλου</option>
    <option value="2">'Ιχνη</option>
    <option value="3">Παθολογικό</option>
    </select>
    &nbsp;&nbsp;
    ...
    <TD>Πυοσφαίρια </TD>
    <TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <INPUT class=input name=Puosfairia<?echo $k?>> (αρ./κοπ)</TD>
    </TR>
    <TR>
    <TD>Ερυθρά</TD>
    <TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <INPUT class=input name=Eruthra<?echo $k?>> (αρ./κοπ)</TD>
    </TR> 
    <TR>
    <TD>Κύλινδροι</TD>
    <TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
echo mysql_error();
    ...
    echo "<th class=result> Λεύκωμα </th>";
    echo "<th class=result>  </th>";
    echo "<th class=result> Πυοσφαίρια </th>";
    echo "<th class=result> Ερυθρά </th>";   
    echo "<th class=result> Κύλινδροι </th>";           
    echo "</tr>\n";
        ...
        for ($j=0; $j<$num_rows; $j++)
        {
            ...
            for ($i=1; $i < 8; $i++)
            {
                ...
                if ($i==3)
                {
                	...
                	{
                		echo "<td class=result>Καθόλου</td>";
                	}
                	else if ($resultrow[$field->name] == 2)
                	{
                		echo "<td class=result>'Ιχνη</td>";
                	}
                	...
                	{
                		echo "<td class=result>Παθολογικό</td>";
                	}  		 
                }
                else if ($i == 7)
                {

...
$sql = "SELECT * FROM hcv_antiiikes_treatments_dosages WHERE StartDate='".$_GET['start']."' AND EndDate='".$_GET['end']."' AND Medicine='".$_GET['Medicine']."' AND link_id='".$_GET['link_id']."' AND PatientCode=".$_GET['code'];
$result = execute_query($sql);
$row = mysql_fetch_assoc($result);
echo mysql_error();
    echo "<form method=get action='hcv_edit_dosage_insert.php' onsubmit='return check_data();'>";
